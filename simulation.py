...
earth_ball = sphere(radius=5, color=color.blue)

system = compound ([earth_ball, earth_cylinder])
...
while True:
    rate(10)
    earth_cylinder.rotate(angle=0.05, axis=earth_cylinder.axis, origin=earth_cylinder.pos)
